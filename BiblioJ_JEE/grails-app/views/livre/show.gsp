		...
		<div id="show-livre" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:actionSubmit action="addToPanier" value="${message(code: 'default.button.addToShoppingCart.label', default: 'Ajouter au Panier')}" onclick="return confirm('${message(code: 'default.button.addToCart.confirm.message', default: 'Vous êtes sur le point d\'ajouter ce livre à votre panier. Voulez-vous continuer? ')}"/>
					<g:select name="nbExemplaires" from="${0..livreInstance?.nombreExemplairesDisponibles}"/>
				</fieldset>
			</g:form>
		</div>
	</body>
